                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Container(
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              CustomButton(width: 98, text: "lbl_follow".tr, variant: ButtonVariant.OutlineWhiteA700, fontStyle: ButtonFontStyle.InterSemiBold14WhiteA700, alignment: Alignment.centerLeft)
                                                                            ]))
                                                                  ])),
                                                          Padding(
                                                              padding:
                                                                    ...
                                                                    Padding(
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(padding: getPadding(left: 9, top: 15, right: 9), child: Text("lbl_75".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterSemiBold20WhiteA700))
                                                                            ])),
                                                                    Padding(
                                                                        padding: getPadding(
                                                                            top:
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(padding: getPadding(left: 19, top: 13, right: 16), child: Text("lbl_3400".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterSemiBold20WhiteA700))
                                                                            ])),
                                                                    Padding(
                                                                        padding: getPadding(
                                                                            top:
                                                                        ...
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Padding(padding: getPadding(left: 20, top: 15, right: 17), child: Text("lbl_6500".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtInterSemiBold20WhiteA700))
                                                                            ]))
                                                                  ]))
                                                        ])))
                                          ])))
