...
import 'package:adowning_social_networking/domain/facebookauth/facebook_auth_helper.dart';
import 'package:adowning_social_networking/domain/googleauth/google_auth_helper.dart';
                                                                        ...
                                                                        child: Row(mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                          Padding(
                                                                              ...
                                                                              child: InkWell(
                                                                                  ...
                                                                                  child: CommonImageView(svgPath: ImageConstant.imgTwitter, height: getVerticalSize(19.00), width: getHorizontalSize(24.00)))),
                                                                          Padding(
                                                                              ...
                                                                              child: InkWell(
                                                                                  ...
                                                                                  child: CommonImageView(svgPath: ImageConstant.imgGoogle, height: getVerticalSize(24.00), width: getHorizontalSize(37.00))))
                                                                        ])))
                                                              ]))
                                                    ]))),
                                        CustomButton(
